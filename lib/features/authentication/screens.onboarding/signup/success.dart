        ...
        child: Padding(
          ...
          child: Column(
            children: [
              ...
              // Buttons
              SizedBox(width: double.infinity, child: ElevatedButton(style:ElevatedButton.styleFrom(backgroundColor:  AppColors.primary,foregroundColor: Colors.black,side: BorderSide(color: Colors.white, width: 0)) ,onPressed: () => Get.to(() => const LoginScreen()), child: const Text(AppTexts.appcontinue))),
