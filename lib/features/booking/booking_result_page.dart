...
import 'package:flutterproject/features/home/view/home.dart';
      ...
      body: SingleChildScrollView(
        ...
        child: Column(
          ...
          children: [
            ...
            // ==============================
            // 3. Phần Thông tin bác sĩ + chi tiết lịch - CẬP NHẬT
            // ==============================
            Container(
              decoration: BoxDecoration(
                color: Colors.white,
                    ...
                    children: [
                      ...
                      Expanded(
                        child: Column(
                          ...
                          children: [
                            Text(
                              doctor.degree, // ex: "BS.CK1"
                              style: TextStyle(fontSize: 13, color: Colors.grey.shade600),
                            ),
                            const SizedBox(height: 4),
                            Text(
                              doctor.user?.username ?? 'Unknown Doctor', // ex: "Vũ Thị Hạnh Thư"
