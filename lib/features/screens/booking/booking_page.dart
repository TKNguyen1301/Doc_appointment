...
import 'package:flutterproject/features/screens/booking/confirm_page.dart';
          ...
          Expanded(
            child: SingleChildScrollView(
              ...
              child: Column(
                ...
                children: [
                  // ============================
                  // 4.1. Thông tin bác sĩ ở trên cùng
                  // ============================
                  Container(
                        ...
                        Expanded(
                          child: Column(
                            ...
                            children: [
                              ...
                              const SizedBox(height: 4),
                              Text(
                                'Chuyên khoa: ${widget.doctor.specialty}',
                                style: TextStyle(
                                  fontSize: 13,
                  ...
                  // Thêm khoảng trống để tránh che nút "Tiếp tục" khi scroll
                ],
              ),
            ),
          ),
            ...
            child: SizedBox(
              ...
              child: ElevatedButton(
                ...
                onPressed: () {
                  ...
                  // Địa chỉ phòng khám (giả sử bạn đã thêm biến address vào Doctor)
                  final String clinicAddress = widget.doctor.address;

                  // Thời điểm đặt lịch:
                  final DateTime bookedAt = now;

                  // Điều hướng sang ConfirmationPage và truyền đủ 8 tham số
